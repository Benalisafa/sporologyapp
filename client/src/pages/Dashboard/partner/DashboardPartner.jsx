...
function DashboardPartner() {
              ...
              <tbody>
                {activities.map(activity => (
                  <tr key={activity._id}>
                    ...
                    <td>
                      <Button  style={{background:'transparent',color:'green', border:'none'}}  size="sm" onClick={() => handleEdit(activity)}><EditIcon/> </Button>
                      <Button style={{background:'transparent',color:'red', border:'none'}} size="sm" onClick={() => handleRemove(activity._id)}><DeleteIcon/> </Button>
                    </td>
                  </tr>
                ))}
              </tbody>
 ...
 <Form.Group controlId="formDate">
   ...
   <Form.Control type="date" value={formatDate(editedActivity.date) || ''} onChange={(e) => setEditedActivity({ ...editedActivity, date: e.target.value })} />
 </Form.Group>
 <Form.Group controlId="formLocation">
   ...
   <Form.Control type="text" value={editedActivity.location || ''} onChange={(e) => setEditedActivity({ ...editedActivity, location: e.target.value })} />
         ...
         <Modal.Footer>
           ...
           <Button className="button-primary" style={{width:'100%'}} onClick={handleSaveChanges}>
             Save Changes
           </Button>
         </Modal.Footer>
       </Modal>
