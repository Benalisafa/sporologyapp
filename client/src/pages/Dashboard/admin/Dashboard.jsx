          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body">
                <img src={logo} className="card-img-absolute" alt="circle" />
                ...
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src={logo} className="mr-2" alt="face" /> David Grey </td>
                      ...
                      <tr>
                        <td>
                          <img src={logo} className="mr-2" alt="face" /> Stella Johnson </td>
                      ...
                      <tr>
                        <td>
                          <img src={logo} className="mr-2" alt="face" /> Marina Michel </td>
                      ...
                      <tr>
                        <td>
                          <img src={logo} className="mr-2" alt="face" /> John Doe </td>
              ...
              <div className="card-body">
                ...
                <div className="row mt-3">
                  <div className="col-6 pr-1">
                    <img src={logo} className="mb-2 mw-100 w-100 rounded" alt="face" />
                    <img src={logo} className="mw-100 w-100 rounded" alt="face" />
                  </div>
                ...
                <div className="d-flex mt-5 align-items-start">
                  <img src={logo} className="img-sm rounded-circle mr-3" alt="face" />
...
//     // Fetch activities with populated userId
...
//           <br />
//           <h5 onClick={handleAddActivityClick}><PhoneIcon />Professionals</h5>
//           <br />
//           <h5 onClick={handleAllActivitiesClick}><PhoneIcon />Activities</h5>
//           <br />
//           <h5 onClick={handleAddActivityClick}><PhoneIcon />Categories</h5>
//           <br />
//           <h5 onClick={handleAddActivityClick}><PhoneIcon />Testimonies</h5>
//         </aside>
//         <div style={{ width: '80%' }}>
